...
//      computer.addMain("Plains");
    ...
    AllZone.Human_Play.add(AllZone.CardFactory.getCard("Liliana Vess", Constant.Player.Human));
    //AllZone.Human_Hand.add(AllZone.CardFactory.getCard("Bribery", Constant.Player.Human));

    AllZone.Computer_Graveyard.add(AllZone.CardFactory.getCard("Man-o'-War", Constant.Player.Computer));
    AllZone.Computer_Graveyard.add(AllZone.CardFactory.getCard("Mulldrifter", Constant.Player.Computer));
